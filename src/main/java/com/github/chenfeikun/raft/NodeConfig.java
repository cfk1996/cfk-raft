...
public class NodeConfig {
    ...
    private int mappedFileSizeForEntryIndex = MmapFileStore.INDEX_UNIT_SIZE * 5 * 1024 * 1024;
    ...
    public NodeConfig group(String group) {
        this.group = group;
        return this;
    }

    public NodeConfig selfId(String selfId) {
        this.selfId = selfId;
        return this;
    }

    public NodeConfig peers(String peers) {
        this.peers = peers;
        return this;
    }

    public NodeConfig storeBaseDir(String dir) {
